<template>
  <ModuleBox class="module-lotteryGema" v-show="isInit" showTitle title="抽奖" type="orange">
    <div class="container">
      <!-- 大转盘 -->
      ...
      <div class="info-box">
        ...
        <a class="btn" href="javascript:void(0);" @click="toMyPrize">我的奖品</a>
      </div>
    </div>
  </ModuleBox>
</template>
...
// import Turnplate from "@llz/components/Turnplate/index.vue"
