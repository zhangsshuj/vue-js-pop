  ...
  <ModuleBox class="module-inviteUserList" showTitle title="我邀请的好友" type="green" v-if="EARN_INVEXT_REL&&EARN_INVEXT_REL.length">
    <div class="container">
      ...
      <div class="header">
        ...
        <span class="h2">{{EARN_INVITED_SHOW_COLUMN == 0 ? "开户奖励" : "实名奖励"}}</span>
...
import StatusBox from "@llz/components/StatusBox/index.vue"
...
export default {
  ...
  methods: {
    async getInviteList () {
      ...
      this.EARN_INVITED_SHOW_COLUMN = data.EARN_INVITED_SHOW_COLUMN;  // 0 开户奖励 1实名奖励
    },
    // 提醒好友
    ...
    async clickGet (type, id) {
      ...
      if (this.$store.state.APP_FLAG == "PMP") {
        ...
        contentDesc = data.FREEZE_FLAG == 1 ? "待好友投资后获得" : "请到我的账户中查看"
      }
