...
export default {
  ...
  methods: {
    ...
    async splitObjData () {
      // &分享链接
      this.shareImgQcodeval = `${this.$Config.baseUrlHost}/activity/llz/index.html#/outSide?PMP_FLAG=${encodeURI(this.head.APP_FLAG)}&MEMBER_ID=${encodeURI(this.head.ID)}&DEVICE_ID=${encodeURI(this.head.DEVICE_ID)}&ACTITY_ID=${this.$store.state.ACTITY_ID}`;
