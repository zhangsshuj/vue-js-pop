...
<script>
    export default {
        ...
        methods: {
            //  初始化数据
            async init () {
                 let list2 = await this.$axios.get('https://mock.yonyoucloud.com/mock/7094/','api/yiye/bankList')
                this.bankData.BANK_LIST = list2.data.data.slice(0,100)
