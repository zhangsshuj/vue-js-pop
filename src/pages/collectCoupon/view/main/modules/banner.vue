...
<template>
  <div class='module-banner'>
    ...
    <ScrollFixedEnd @scroll="isHidden=true" @scrollEnd="isHidden=false" :delay="1000">
...
export default {
  ...
  methods: {
    ...
    showShare () {
      ...
      let shareJson = this.getShareConfig(btns);
      this.$root.$refs["SharePopup"].open(shareJson, this.shareSuccess);
    },
