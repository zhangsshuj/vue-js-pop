...
export default {
    ...
    methods: {
        ...
        StageTwoAnimate (timer = 0) {
            ...
            this.TweenLine.to(this.swiperContainer, 1.800 * this.TweenLineScale, { onEnd: () => { this.$localStore("set", { key: "is_open", value: JSON.stringify({ isRead: "1", isOpen: "1" }) }); }, top: this.$px2rem(480), ease: JT.Cubic.Out }, "TIME_LINE+=2")
